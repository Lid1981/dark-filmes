  ...
  return (
    <PageWrapper>
      <div className="w-full flex flex-col items-center justify-center pt-7">
        <h1 className="text-[40px] text-[#FF00FF] font-bold">Sua Coleção de Filmes</h1>
        <p className="text-[#FF00FF] font-bold text-[25px]">Acompanhe seus filmes favoritos. Adicione novos filmes à sua coleção</p>
      </div>
