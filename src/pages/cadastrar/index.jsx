    ...
    return (
        <PageWrapper  showButton={false}>
            <div className="w-full h-full py-[40px] px-[70px] flex flex-col">
                <h1 className="text-[40px] font-bold text-[#FF00FF]">Adicione um novo filme</h1>
                <p className="text-[20px] text-[#FF00FF] font-bold">Preencha o formulário abaixo para adicionar um novo filme à sua coleção.</p>
                <div className="w-full flex justify-center pt-[40px]">
                    <form 
                        onSubmit={handleSubmit}
                        className="w-[50%] h-auto min-h-[200px] bg-[#222222] font-bold text-[#FF00FF] rounded-2xl border border-[#3a364c] flex flex-col p-6 gap-4">
                        <CustomInput 
                            label="Título"
                            value={titulo}
                        ...
                        <div className="w-full flex gap-4">
                            <div className="w-[50%] font bold text-[12px] text-[#FF00FF]">
                                <CustomInput
                                    label="Ano"
                                    value={ano}
                        ...
                        <div className="w-full flex justify-end gap-4">
                            ...
                            <button 
                                ...
                                className="w-[130px] h-[50px] rounded-md
                                 bg-[#A020F#A020F0] cursor-pointer font-bold
                                 hover:bg-[#9A86F4]/80"
                            >
                                    Salvar Filme
                            </button>
